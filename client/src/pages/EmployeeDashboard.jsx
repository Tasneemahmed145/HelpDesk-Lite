...
import { PlusCircle, Search, RefreshCw, AlertCircle, CheckCircle, Clock } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">Create and manage your company support requests</p>
        </div>
        <Link
          to="/create-ticket"
          className="inline-flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-4 rounded shadow-sm transition-colors text-sm"
        >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        <div className="bg-white border border-gray-200 p-4 rounded-lg flex items-center space-x-3 shadow-xs">
          ...
          <div>
            <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider block">Total Created</span>
